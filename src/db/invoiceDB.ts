...
class InvoiceDB extends Dexie {
  ...
  constructor() {
    ...
    // Migration v4 — Ajout de l'index `updatedAt` pour la résolution de conflits offline
    // Stratégie LWW (Last-Write-Wins) : on compare updatedAt lors du merge Firestore ↔ IndexedDB
