...
describe('FormField', () => {
  it("affiche le label et l'input avec la valeur", () => {
    ...
    render(<FormField label="Nom de l'entreprise" value="Ma Boite" onChange={onChange} />);
  ...
  it("affiche l'erreur si présente", () => {
    render(<FormField label="Téléphone" value="" onChange={() => {}} error="Numéro invalide" />);
  ...
  it('affiche une astérisque si requis', () => {
    render(<FormField label="Siret" value="" onChange={() => {}} required={true} />);
