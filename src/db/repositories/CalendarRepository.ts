...
export const calendarRepository = {
  ...
  findById: (id: string): Promise<CalendarEvent | undefined> =>
    db.calendarEvents.get(id),
  ...
  saveBulk: (events: CalendarEvent[]): Promise<string> =>
    db.calendarEvents.bulkPut(events),
