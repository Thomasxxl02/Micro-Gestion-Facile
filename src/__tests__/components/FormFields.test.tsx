...
describe("FormFields Components", () => {
  ...
  describe("ToggleSwitch", () => {
    it("rend un switch et bascule la valeur au clic", () => {
      ...
      const { rerender } = render(
        <ToggleSwitch label="Activer" checked={false} onChange={handleChange} />
      );
      ...
      rerender(<ToggleSwitch label="Activer" checked={true} onChange={handleChange} />);
  ...
  describe("ColorPicker", () => {
    it("affiche la valeur hexadécimale et réagit au changement", () => {
      const handleChange = vi.fn();
      render(<ColorPicker label="Thème" value="#ff0000" onChange={handleChange} />);
    ...
    it("sélectionne une couleur prédéfinie", () => {
      const handleChange = vi.fn();
      render(<ColorPicker label="Thème" value="#000000" onChange={handleChange} />);
