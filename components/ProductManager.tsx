      ...
      <div className="bento-grid">
          <div className="bento-item">
              <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-[10px] font-bold text-brand-400 uppercase tracking-widest">Total Catalogue</span>
              </div>
              <div>
                  <h3 className="text-2xl font-bold text-brand-900 dark:text-white font-display">{globalStats.total}</h3>
          ...
          <div className="bento-item">
              <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-[10px] font-bold text-brand-400 uppercase tracking-widest">Prestations</span>
              </div>
              <div>
          ...
          <div className="bento-item">
              <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-[10px] font-bold text-brand-400 uppercase tracking-widest">Stock Bas</span>
              </div>
              <div>
                  <h3 className="text-2xl font-bold text-amber-600 dark:text-amber-400 font-display">{globalStats.lowStockCount}</h3>
                  <p className="text-xs text-brand-500 dark:text-brand-400 mt-1">Articles à réapprovisionner</p>
              </div>
          </div>
