...
describe('FormFields Extra', () => {
  describe('TextAreaField', () => {
    it('devrait rendre correctement avec label et valeur', () => {
      ...
      render(<TextAreaField label="Commentaires" value="Test content" onChange={onChange} />);
  ...
  describe('SelectField', () => {
    it('devrait rendre les options et gérer le changement', () => {
      ...
      render(<SelectField label="Choix" value="a" options={options} onChange={onChange} />);
  ...
  describe('ToggleSwitch', () => {
    it('devrait changer d etat au clic', () => {
      const onChange = vi.fn();
      render(<ToggleSwitch label="Activer" checked={false} onChange={onChange} />);
