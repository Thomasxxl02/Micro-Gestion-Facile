    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Note accessibilité et sécurité */}
          <div className="mt-4 space-y-1">
            <p className="text-xs text-blue-600 dark:text-blue-400 italic">
              💡 Le lien expire après 15 minutes pour des raisons de sécurité.
            </p>
            {!isMaxResendsReached && resendCount > 0 && (
              <p className="text-[10px] text-blue-500 dark:text-blue-500 font-medium">
                Tentative de renvoi {resendCount} sur 3 (Maximum 3 autorisés)
              </p>
            )}
            {isMaxResendsReached && (
