      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-brand-500">
            Gérez vos envois de factures, devis et relances.
          </p>
        </div>
        <button
          onClick={() => {
              ...
              <tbody className="divide-y divide-brand-50">
                ...
                {filteredEmails.length === 0 && (
                  <tr>
                    <td
                      colSpan={5}
                      className="px-6 py-20 text-center text-brand-400 italic"
                    >
              ...
              <div className="space-y-6 animate-fade-in">
                <div className="p-6 bg-brand-50 rounded-2xl border border-brand-100">
                  <div className="mb-4 pb-4 border-b border-brand-200">
                    <div className="text-xs font-bold text-brand-400 uppercase mb-1">
                      À:
                    </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setComposeData({
                          ...composeData,
                          type: e.target.value as Email["type"],
                        })
                      }
                    >
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-accent-50 border border-accent-100 rounded-4xl p-6">
              ...
              <p className="text-xs text-accent-700 leading-relaxed">
                Utilisez l'aide à la rédaction pour générer des relances polies
                mais fermes, ou des messages d'accompagnement personnalisés pour
                vos factures.
              </p>
            </div>
          </div>
