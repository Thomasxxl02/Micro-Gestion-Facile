    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" role="presentation">
      ...
      >
        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            <h2 id="entity-modal-title" className="text-2xl font-black text-brand-900 dark:text-white tracking-tight">
              {title}
            </h2>
            {subtitle && <p id="entity-modal-subtitle" className="mt-1 text-sm font-bold text-brand-400 dark:text-brand-500 uppercase tracking-widest">{subtitle}</p>}
          </div>
          <button
            onClick={onClose}
        ...
        {/* Footer - Actions */}
        <div className={`flex flex-wrap gap-3 ${isDangerous ? 'border-t border-red-100 pt-6 dark:border-red-900/30' : ''}`}>
