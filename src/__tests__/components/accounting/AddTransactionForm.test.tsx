...
describe('AddTransactionForm', () => {
  it('affiche le formulaire correctement', () => {
    ...
    expect(screen.getByPlaceholderText(/Ex: Abonnement Internet/i)).toBeInTheDocument();
  ...
  it('appelle handleAddExpense au submit', async () => {
    ...
    render(<AddTransactionForm {...mockProps} handleAddExpense={handleAddExpense} />);
  ...
  it('gère le changement de montant TTC et calcule la TVA', () => {
    ...
    render(<AddTransactionForm {...mockProps} setNewExpense={setNewExpense} handleFormChange={handleFormChange} />);
